...
const AllReview = ({reviews}) => {
    ...
    return (
        ...
        <div className="flex items-center mb-4 space-x-4">
           {UserImage ?<div className='w-10 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2'>
  ...
  <div className="w-10 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
    <img src="https://placeimg.com/192/192/people" alt='' />
            ...
            <div className="space-y-1 font-medium dark:text-white">
                <p>{name ? name : "Abdullah"} <time datetime="2014-08-16 19:00" className="block text-sm  dark:text-gray-400">Joined on August 2014 at {date}</time></p>
            </div>
        </div>
