    ...
    return (
      ...
      <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0 z-10">
        ...
        <div className='absolute top-20 text-center w-full'>
          <p className='text-md font-sans text-white'>Let's travel the world with us</p>
         <h1 className='md:text-5xl text-3xl font-serif capitalize text-yellow-50 mb-3 stroke-1'>Explore the  World </h1> <h1 className='md:text-5xl text-3xl font-serif capitalize text-blue-300'>with Travol</h1>
